...
db_path = "../etl-pipeline/output/etl_pipeline.db"
...
data_dict_schema = {
    "historian_clean": [
        ...
        {"Column": "failure_type", "Data Type": "VARCHAR(50)", "Units": "N/A", "Source System": "Historian CSV",
         "Update Frequency": "Per scenario", "Null Handling": NOTNULL, "Quality Flag Meaning": "none | bearing | cavitation | insulation"},
    ...
    "alarm_log_clean": [
        ...
        {"Column": "is_test_case", "Data Type": "VARCHAR(10)", "Units": "N/A", "Source System": "Alarm Log CSV",
         "Update Frequency": "Event-driven", "Null Handling": "Mostly null in source", "Quality Flag Meaning": ""},
        {"Column": "quality_flag", "Data Type": "VARCHAR(50)", "Units": "N/A", "Source System": "ETL pipeline",
         "Update Frequency": "Per ETL run", "Null Handling": NOTNULL, "Quality Flag Meaning": FLAG},
    ],
...
for table_name in ["historian_clean", "alarm_log_clean", "environmental_clean"]:
    try:
...
excel_path = "output/data_dictionary.xlsx"
